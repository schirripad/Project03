	...
	public static void generateAddresses(int bound, int howManyAddress) throws IOException {
		...
		while (count < howManyAddress) {
			for (int i = 0; i < howManyAddress; i++) {
				...
				// Creates required random integers to randomize orders and create real world
				// data DH
				...
				// If house number dived by 100 does not equal zero and does not equal 1000 then
				// append it, we do not want
				...
				for (int j = 0; j < randomSandwichNumber; j++) {
					...
					if (randomBread == 1) {
						strBuilder.append(" Order: Bread: " + randomBread);
					}
					...
					/*
					 * RANDOM BREAD GENERATES A RANDOM NUMBER 1 THRU 2 1. Means that the bread is a
					 * WRAP 2. Means that the bread is a ROLL
					 * 
					 * YOU CANNOT HAVE BOTH!
					 */

					if (randomMeat == 1) {
						strBuilder.append(" Meat: " + randomMeat);
					}
					...
					/*
					 * RANDOM MEAT GENERATES A RANDOM NUMBER 1 THRU 3 1. Means that the meat is
					 * Turkey 2. Means that the meat is Ham 3. Means that the meat is BOTH TURKEY
					 * AND HAM
					 */
					...
					/*
					 * RANDOM CONDIMENT GENERATES A RANDOM NUMBER 1 THRU 8 (SORRY!) 1. Means that
					 * the customer wants NO CONDIMENTS! 2. Means that the condiment is JUST MAYO 3.
					 * Means that the condiment is JUST CHEESE 4. Means that the condiment is JUST
					 * MUSTARD 5. Means that the condiment is MAYO AND CHEESE 6. Means that the
					 * condiment is MAYO AND MUSTARD 7. Means that the condiment is CHEESE AND
					 * MUSTARD 8. Means that the condiment is MAYO AND CHEESE AND MUSTARD
					 */
					...
					/*
					 * RANDOM VEGETABLES GENERATE A RANDOM NUMBER 1 THRU 4 1. Means that the
					 * customer wants NO VEGETABLES 2. Means that the customer wants LETTUCE 3.
					 * Means that the customer wants TOMATO 4. Means that the customer wants LETTUCE
					 * AND TOMATO
					 */
					...
					/*
					 * RANDOM DRINK GENERATES A RANDOM NUMBER 1 THRU 4 <-- THIS IS EXTRA SO I ADDED
					 * PRICES TOO! 1. Means NO DRINK (COST $0.00) 2. Means Coca-Cola (COST $1.25) 3.
					 * Means Diet Coca-Cola (COST $1.25) 4. Means Bottled Water (COST $1.25)
					 */
					...
					/*
					 * RANDOM CHIP GENERATES A RANDOM NUMBER 1 THRU 3 <-- THIS IS EXTRA SO I ADDED
					 * PRICES TOO! 1. Means NO CHIPS (COST $0.00) 2. Means Potato Chips (COST $0.50)
				...
				// Gives us a random order including multiple orders according to client
				// specifications DH
