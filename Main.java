...
public class Main {
	...
	public static void main(String[] args) {
		// Make sure to change the distributionCenter in SandwichTruck class to be the
		// same.
		...
		try {
			...
			AddressGenerator.generateAddresses(9, 3);
			...
			// The sandwich truck return to the distribution center after all deliveries are
			// completed.
