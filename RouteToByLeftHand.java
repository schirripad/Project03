 ...
 * with the delaying units of Left-hand turn, besides the total route length.
 *
 * @author Rio
 *
 */
...
public class RouteToByLeftHand implements Router{
    ...
    RouteToByLeftHand(Collection<Order> orderss, SandwichTruck t){
        ...
        */
            ...
            if (a.getStreetDirection() == truck.getStreetDirection() && sameStreetNum) {
                ...
                if ((truck.getStreetDirection() == StreetDirection.SOUTH && truckHeading == 1 && a.getHouseNumber() > truck.getHouseNumber())) {
                    ...
                    instructions.add(new Instruction(new Address((truck.getStreetNumber() - 1)*100,corner/100,  StreetDirection.EAST), 4000));
                ...
                // Good!
                    ...
                    instructions.add(new Instruction(new Address((corner + 100),truck.getStreetNumber(), StreetDirection.SOUTH), 4000));
                    instructions.add(new Instruction(new Address(truck.getStreetNumber() * 100, (corner + 100) / 100, StreetDirection.EAST)));

                    instructions.add(new Instruction(new Address((truck.getStreetNumber() + 1)*100,(corner + 100)/100,  StreetDirection.EAST), 4000));
                ...
                // Good!
                    ...
                    instructions.add(new Instruction(new Address( (truck.getStreetNumber() - 1)*100,(corner + 100)/100, StreetDirection.SOUTH), 4000));
                ...
                // Good!
                    ...
                    instructions.add(new Instruction(new Address( corner ,truck.getStreetNumber() , StreetDirection.EAST), 4000));
                    instructions.add(new Instruction(new Address(truck.getStreetNumber() * 100, corner / 100, StreetDirection.SOUTH)));

                    instructions.add(new Instruction(new Address((truck.getStreetNumber() + 1)*100,corner/100,  StreetDirection.SOUTH), 4000));
                    instructions.add(new Instruction(new Address(corner, truck.getStreetNumber() + 1, StreetDirection.EAST)));
                    truckHeading = 2;
                    routeLength += Math.abs(truck.getHouseNumber() -corner);
                        ...
                        if (hNum > truckHouseNum) {
                            if (truckHeading == 1) { //(←)South
                                ...
                                // working on
                                    ...
                                    instructions.add(new Instruction(new Address(truckStreetNum * 100, corner / 100, StreetDirection.EAST)));
                                    routeLength += Math.abs(truck.getHouseNumber() - corner);
                                    instructions.add(new Instruction(new Address((truckStreetNum - 1)*100,corner/100, StreetDirection.EAST), 4000));
                                    instructions.add(new Instruction(new Address(corner, truckStreetNum - 1, StreetDirection.SOUTH)));
                                    routeLength += 100;
                                    truckHeading = 3;
                                ...
                                if (sNum < truckStreetNum) {
                                    ...
                                    routeLength += Math.abs(truck.getHouseNumber() - (corner + 100));
                                    //....
                                    instructions.add(new Instruction(new Address((truckStreetNum + 1)*100,(corner + 100)/100, StreetDirection.EAST), 4000));
                                    instructions.add(new Instruction(new Address((corner + 100), truckStreetNum + 1, StreetDirection.SOUTH)));
                                    routeLength += 100;
                                    truckHeading = 1;
...
//							corner =truckHouseNum - (truckHouseNum  % 100);
                                if (sNum > truckStreetNum) {
                                    ...
                                    instructions.add(new Instruction(new Address(truckStreetNum * 100, corner / 100, StreetDirection.SOUTH)));
                                    routeLength += Math.abs(truck.getHouseNumber() - corner);
                                    instructions.add(new Instruction(new Address( (truckStreetNum + 1)*100,corner/100, StreetDirection.SOUTH), 4000));
                                    instructions.add(new Instruction(new Address(corner, truckStreetNum + 1, StreetDirection.EAST)));
                                    truckHeading = 2;
                                    routeLength += 100;
                                ...
                                if (sNum > truckStreetNum) {
                                    ...
                                    routeLength += Math.abs(truck.getHouseNumber() - (corner + 100));
                                    instructions.add(new Instruction(new Address( (truckStreetNum - 1)*100,(corner + 100)/100, StreetDirection.SOUTH), 4000));
                                    instructions.add(new Instruction(new Address((corner + 100), truckStreetNum - 1, StreetDirection.EAST)));
                                    truckHeading = 4;
                                    routeLength += 100;
                    ...
                    if (truckDir == StreetDirection.SOUTH) {
                        ...
                        if (truckHeading == 1) {
                            ...
                            if (hNum > y1 * 100) {
                                ...
                                instructions.add(new Instruction(new Address(y1 * 100, corner / 100, StreetDirection.EAST)));
                                routeLength += Math.abs(truck.getHouseNumber() - corner);
                                instructions.add(new Instruction(new Address((y1 - 1)*100,corner/100,  StreetDirection.EAST), 4000));
                                instructions.add(new Instruction(new Address(corner, y1 - 1, StreetDirection.SOUTH)));

                                instructions.add(new Instruction(new Address((corner + 100),(y1 - 1) ,  StreetDirection.SOUTH), 4000));
                                instructions.add(new Instruction(new Address((y1 - 1) * 100, (corner + 100) / 100, StreetDirection.EAST)));
                                routeLength += 200;
                                truckHeading = 2;
                            ...
                            if (hNum > y1 * 100){
                                ...
                                //Done
                                int corner = truckHouseNum - (truckHouseNum % 100);
                                instructions.add(new Instruction(new Address((corner + 100) ,y1,  StreetDirection.SOUTH), 4000));
                                instructions.add(new Instruction(new Address(y1 * 100, (corner + 100) / 100, StreetDirection.EAST)));
                                routeLength += Math.abs(truck.getHouseNumber() - (corner + 100));
                                instructions.add(new Instruction(new Address((y1 + 1)*100,(corner + 100)/100,  StreetDirection.EAST), 4000));
                                instructions.add(new Instruction(new Address((corner + 100), y1 + 1, StreetDirection.SOUTH)));

                                instructions.add(new Instruction(new Address((corner),(y1 + 1) ,  StreetDirection.SOUTH), 2000));
                                instructions.add(new Instruction(new Address((y1 + 1) * 100, (corner / 100), StreetDirection.EAST)));
                                routeLength += 200;
                        ...
                        if (truckHeading == 2) {
                            if (hNum > y1 * 100) {
                                int corner = truckHouseNum - (truckHouseNum % 100);
                                instructions.add(new Instruction(new Address( (corner + 100),y1, StreetDirection.EAST), 4000));
                                instructions.add(new Instruction(new Address(y1 * 100, (corner + 100) / 100, StreetDirection.SOUTH)));
                                routeLength += Math.abs(truck.getHouseNumber() - (corner + 100));
                                instructions.add(new Instruction(new Address((y1 - 1)*100,(corner + 100)/100,  StreetDirection.SOUTH), 4000));
                                instructions.add(new Instruction(new Address((corner + 100), y1 - 1, StreetDirection.EAST)));

                                instructions.add(new Instruction(new Address((corner),(y1 - 1),StreetDirection.EAST), 4000));
                                instructions.add(new Instruction(new Address((y1 - 1) * 100, (corner) / 100, StreetDirection.SOUTH)));
                                routeLength += 200;
                                truckHeading = 3;
                            ...
                            if (hNum > y1 * 100){
                                ...
                                instructions.add(new Instruction(new Address(y1 * 100, corner / 100, StreetDirection.SOUTH)));
                                routeLength += Math.abs(truck.getHouseNumber() - corner);
                                instructions.add(new Instruction(new Address((y1 + 1)*100,corner/100,  StreetDirection.SOUTH), 4000));
                                instructions.add(new Instruction(new Address(corner, y1 + 1, StreetDirection.EAST)));

                                instructions.add(new Instruction(new Address((corner + 100),(y1 + 1) ,  StreetDirection.EAST), 4000));
                                instructions.add(new Instruction(new Address((y1 + 1) * 100, (corner + 100) / 100, StreetDirection.SOUTH)));
                                routeLength += 200;
                                truckHeading = 1;
